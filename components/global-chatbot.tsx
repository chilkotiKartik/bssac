...
import { Bot, Send, Mic, X, User, MessageSquare } from "lucide-react"
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content:
        language === "hi"
          ? "नमस्ते! मैं उत्तराखंड गाइड हूँ, उत्तराखंड के बारे में आपके सवालों का जवाब देने के लिए यहाँ हूँ। मैं आपको पहाड़ी वाक्यांश सिखा सकता हूँ, यात्रा स्थलों का सुझाव दे सकता हूँ, और संस्कृति से संबंधित प्रश्नों का उत्तर दे सकता हूँ। कृपया मुझसे कुछ पूछें!"
          : "Namaste! I'm Uttarakhand Guide, here to answer your questions about Uttarakhand. I can teach you Pahadi phrases, suggest travel destinations, and answer cultural queries. Please ask me something!",
    },
  ])
  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-6 left-6 z-50 rounded-full h-14 w-14 bg-uttarakhand-mountain hover:bg-uttarakhand-mountain/90 dark:bg-uttarakhand-meadow dark:text-uttarakhand-pine dark:hover:bg-uttarakhand-meadow/90 shadow-lg"
      >
        <MessageSquare className="h-6 w-6" />
        <span className="sr-only">{language === "hi" ? "चैट शुरू करें" : "Start Chat"}</span>
      </Button>
          ...
          <Card className="w-full max-w-md h-[600px] flex flex-col">
            <CardHeader className="pb-3 border-b flex justify-between items-center">
              <div className="flex items-center gap-3">
                <Avatar>
                  <AvatarImage src="/placeholder.svg?height=40&width=40" alt="Uttarakhand Guide" />
                  <AvatarFallback>
                    <Bot />
                  </AvatarFallback>
                </Avatar>
                <div>
                  <CardTitle className="text-lg font-pahadi">
                    {language === "hi" ? "उत्तराखंड गाइड" : "Uttarakhand Guide"}
                  </CardTitle>
