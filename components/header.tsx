...
export default function Header() {
  ...
  const navigation = [
    ...
    { name: language === "hi" ? "पर्यटन" : "Tourism", href: "/tourism" },
    { name: language === "hi" ? "शॉप" : "Shop", href: "/shop" },
    { name: language === "hi" ? "पॉडकास्ट" : "Podcasts", href: "/podcasts" },
    { name: language === "hi" ? "गैलरी" : "Gallery", href: "/gallery" },
    { name: language === "hi" ? "सफलता की कहानियाँ" : "Success Stories", href: "/success-stories" },
